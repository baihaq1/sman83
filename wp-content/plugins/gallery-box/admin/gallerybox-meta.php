...
$gallery_box_meta->add_group_field( $simage_group_id, array(
		...
		'options'          => array(
			...
			'masonry_layout_two'   => __( 'Masonry gallery layout style two', 'gbox' ),
			'masonry_layout_three'   => __( 'Masonry gallery layout style three', 'gbox' ),
...
$settings_group = $gallery_box_meta->add_field( array(
	...
	$gallery_box_meta->add_group_field( $settings_group, array(
		...
		'options'          => array(
			...
			'masonry_two'   => __( 'masonry layout style two', 'gbox' ),
			'masonry_three'   => __( 'masonry layout style three', 'gbox' ),
...
$port_settings_group = $gallery_box_meta->add_field( array(
	...
	$gallery_box_meta->add_group_field( $port_settings_group, array(
		'name'             => __( 'Select hover animation', 'gbox' ),
		'desc'             => __( 'This hover animation only for this image gallery.', 'gbox' ),
		'id'               => 'uni_img_hover',
		'type'             => 'pw_select',
		'default'          => 'default',
		'options'          => array(
...
$you_settings = $gallery_box_meta->add_field( array(
	...
	$gallery_box_meta->add_group_field( $you_settings, array(
		'name'             => __( 'Select hover animation', 'gbox' ),
		'desc'             => __( 'This hover animation only for this Youtube gallery.', 'gbox' ),
		'id'               => 'you_hover',
		'type'             => 'pw_select',
		'default'          => 'default',
		'options'          => array(
	...
	$gallery_box_meta->add_group_field( $you_settings, array(
		'name'             => __( 'Load more button for this gallery', 'gbox' ),
		'desc'             => __( 'You may enable or disable load more button for this Youtube gallery.', 'gbox' ),
		'id'               => 'you_loadmore',
		'type'             => 'pw_select',
		'default'          => 'default',
		'options'          => array(
	...
	$gallery_box_meta->add_group_field( $vimeo_settings, array(
		'name'             => __( 'Select hover animation', 'gbox' ),
		'desc'             => __( 'This hover animation only for this vimeo gallery.', 'gbox' ),
		'id'               => 'vimeo_hover',
		'type'             => 'pw_select',
		'default'          => 'default',
		'options'          => array(
	...
	$gallery_box_meta->add_group_field( $vimeo_settings, array(
		'name'             => __( 'Load more button for this gallery', 'gbox' ),
		'desc'             => __( 'You may enable or disable load more button for this Vimeo gallery.', 'gbox' ),
		'id'               => 'vimeo_loadmore',
		'type'             => 'pw_select',
		'default'          => 'default',
		'options'          => array(
...
//iframe gallery settings
	...
	$gallery_box_meta->add_group_field( $iframe_settings, array(
		'name'             => __( 'Select hover animation', 'gbox' ),
		'desc'             => __( 'This hover animation only for this iframe gallery.', 'gbox' ),
		'id'               => 'iframe_hover',
		'type'             => 'pw_select',
		'default'          => 'default',
		'options'          => array(
	...
	$gallery_box_meta->add_group_field( $iframe_settings, array(
		'name'             => __( 'Load more button for this gallery', 'gbox' ),
		'desc'             => __( 'You may enable or disable load more button for this iframe gallery.', 'gbox' ),
		'id'               => 'iframe_loadmore',
		'type'             => 'pw_select',
		'default'          => 'default',
		'options'          => array(
    ...
    $gallery_box_meta->add_group_field( $help_groupe, array(
		'desc' => '<a class="ads-show" href="http://wpthemespace.com/product/x-blog/" target="_blank"><img src="https://wpthemespace.com/wp-content/uploads/2019/01/xblog-pro.png" alt="Xblog pro" /></a><a class="five-star" href="">'.__('If you love the gallery then Please give five stars rating .  Your five stars will encourage me a lot.','gbox').'</a>',
		'id'   => 'awesome_boot',
		'type' => 'text',
	) );    
