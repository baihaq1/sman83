...
final class gute_Customize {
		...
		$manager->add_section(
			new gute_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'  => 'https://wpthemespace.com/product/gute/?add-to-cart=559',
					'priority' => 10, 
				)
			)
		);
	...
	public function enqueue_control_scripts() {
		...
		wp_enqueue_style( 'gute-customize-controls', trailingslashit( get_template_directory_uri() ) . 'inc/info/customize-controls.css' );
	}
}
