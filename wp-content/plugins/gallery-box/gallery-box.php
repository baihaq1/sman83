...
wp_enqueue_style( 'gallery-box-main', plugins_url( '/assets/css/gallerybox-style.css', __FILE__ ), array(), '1.6.0', 'all');
...
if ( ! function_exists( 'gbox_admin_scripts' ) ) :
 function gbox_admin_scripts() {
	...
	wp_enqueue_style('gallerybox-admin', plugins_url('/assets/css/gallerybox-admin.css', __FILE__), array(), '1.6.0', 'all' );
...
wp_enqueue_script( 'gallerybox-main-admin', plugins_url( '/assets/js/main-admin.js', __FILE__ ), array( 'jquery' ), '1.6.0', true);
