        ...
        $settings_fields = array(
            ...
            'img_style' => array(
				...
				array(
                    ...
                    'desc'    => __( 'You can use load more button for pagination.', 'gbox' ),
                    'type'    => 'radio',
                    'default' => 'enable',
                    'options' => array(
				...
				array(
                    ...
                    'desc'    => __( 'Select how many item show in first page.', 'gbox' ),
                    'type'   => 'number',
                    'default' => 10,
            ...
            'youtube_style' => array(
				...
				array(
                    ...
                    'desc'    => __( 'Select how many item show in every page.', 'gbox' ),
                    'type'   => 'number',
                    'default' => 10,
