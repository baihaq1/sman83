		...
		// Main welcome content
			...
			'quick_links' => array(
                ...
                'demo_url' => array(
                    ...
                    'url'  => 'http://gute.wpthemium.com/gute-preview',
                ),
                ...
                'six' => array(
					...
					'recommended_actions'        => array(
						...
						'content'            => array(
							...
							'go-pro' => array(
								'title'       => '<a target="_blank" class="activate-now button button-primary" href="https://wpthemespace.com/product/gute/?add-to-cart=559">'.__('UPGRADE TO PRO','gute').'</a>',
								'description' => __( 'You will get more frequent updates and quicker support with the Pro version.', 'gute' ),
